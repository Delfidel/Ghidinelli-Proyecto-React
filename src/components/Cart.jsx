            ...
            <div className="row">
                ...
                <div className="col-md-12">
                    <table className="table">
                        <tr>
                            <td className="text-end" colSpan={5}><Link className="btn btn-info bg-info" onClick={() => {clear()}}>Vaciar Carrito</Link></td>
                        </tr>
                        {
                            cart.map(item => ( 
                                <tr key={item.index}>
                                    ...
                                    <td className="text-end align-middle" width="20%"><button type="button" className="btn btn-info bg-info" onClick={() => {removeItem(item.index)}} title={"Eliminar Producto"}><img src={trash} alt={"Eliminar Producto"} width={32} /></button></td>
                                </tr>
                            ))
                        }
                        <tr>
                            ...
                            <td className="text-end"><Link to={"/checkout"} className="btn btn-info bg-info">Finalizar Compra</Link></td>
                        </tr>
                    </table>
                </div>
            </div>
